...
.page-partners {
  ...
  .dot {
    ...
    &.third {
      top: 0;
      right: calc(50% - calc(195px / 2));
      width: 195px;
      height: 195px;

      @media (max-width: $lg) {
        right: calc(50% - calc(195px / 1.2));
      }
